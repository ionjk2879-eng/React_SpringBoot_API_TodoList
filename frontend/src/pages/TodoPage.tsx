    ...
    <div className="min-h-screen bg-[#F5F5F7] flex flex-col">
      ...
      <header className="h-11 bg-white border-b border-[#D2D2D7] flex items-center px-4 gap-3 flex-shrink-0">
        ...
        <button
          ...
          aria-label="전체 할 일로 이동"
          className="flex items-center gap-2 rounded-md px-1 py-0.5 hover:bg-[#ECECEF] transition-colors"
        >
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="min-w-0 flex-1">
                ...
                <p className="text-sm text-[#86868B] mt-0.5 truncate">
                  {formatToday()} · 해야 할 일 {counts.todo}개 · 마감임박 {counts.progress}개 · 기한초과 {counts.overdue}개 · 완료 {counts.done}개
                </p>
              </div>
